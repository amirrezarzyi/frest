            ...
            <div id="account-details" class="content">
               ...
               <div class="row g-3">
                  <div class="col-sm-6">
                     ...
                     <input type="text" id="username" name="username" class="form-control text-start"  placeholder="061234567(کدملی)" value="{{ old('username') }}">
                     <div class="mt-1">
                        @error('username')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
                  ...
                  <div class="col-sm-6">
                     ...
                     <input type="text" name="email" id="email" class="form-control text-start"  placeholder="aliamiri@email.com" value="{{ old('email') }}">
                     <div class="mt-1">
                        @error('email')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
