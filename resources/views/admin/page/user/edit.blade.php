...
@section('title', 'مدیریت - ویرایش کاربر')
...
@section('content')
<h4 class="breadcrumb-wrapper mb-1"><small class="text-muted fw-light"><a href="">کاربران</a>/</small> ویرایش کاربر <small >( {{ $user->full_name }} )</small></h4>
<!-- Default Wizard -->
<div class="col-12">
         ...
         <form action="{{ route('admin.user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="account-details" class="content">
               ...
               <div class="d-flex align-items-start align-items-sm-center gap-4 mb-3">
                  <img src="{{ asset($user->avatar == null ? 'https://www.psi.org.kh/wp-content/uploads/2019/01/profile-icon-300x300.png' : $user->avatar) }}"  alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar">
                  <div class="button-wrapper">
                     <label for="upload" class="btn btn-sm btn-primary me-2 mb-4" tabindex="0">
                     <span class="d-none d-sm-block">ویرایش تصویر</span>
            ...
            <div id="personal-info" class="content">
               ...
               <div class="row g-3">
                  <div class="col-sm-6">
                     ...
                     <input type="text" id="first-name" name="first_name" class="form-control" placeholder="علی" value="{{ old('first_name',$user->first_name) }}">
                     <div class="mt-1">
                        @error('first_name')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
                  ...
                  <div class="col-sm-6">
                     ...
                     <input type="text" id="last-name" name="last_name" class="form-control" placeholder="امیری" value="{{ old('last_name',$user->last_name) }}">
                     <div class="mt-1">
                        @error('last_name')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
                  ...
                  <div class="col-sm-6">
                     ...
                     <input type="text" id="first-name" name="mobile" class="form-control" placeholder="09123456789" value="{{ old('mobile',$user->mobile) }}">
                     <div class="mt-1">
                        @error('mobile')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
                  ...
                  <div class="col-sm-6">
                     ...
                     <input type="text" id="last-name" name="address" class="form-control" placeholder="خراسان جنوبی - بیرجند - مدرس 11و13" value="{{ old('address',$user->address) }}">
                     <div class="mt-1">
                        @error('address')
                        <span class="text-danger"> * {{ $message }}</span>
                        @enderror
               ...
               <div class="row g-3">
                  <div class="col-md-6 mb-4">  
                     <div class="position-relative""> 
                           @php
                              $org = App\Models\Organization::where('id', old('organization_id',$user->organization_id))->first();
                           @endphp 
